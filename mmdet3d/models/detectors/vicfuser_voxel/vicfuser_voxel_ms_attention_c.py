...
class MS_NaiveCompressor(nn.Module):
    def __init__(self, input_dim, c_compress_ratio, s_compress_ratio):
        ...
        self.compressor1 = NaiveCompressor_UNet(
            input_dim, c_compress_ratio, s_compress_ratio1
        )
        self.compressor2 = NaiveCompressor_UNet(
            input_dim, c_compress_ratio, s_compress_ratio2
        )
        self.compressor3 = NaiveCompressor_UNet(
            input_dim, c_compress_ratio, s_compress_ratio3
        )
...
class VICFuser_Voxel_MS_Attention_C(BaseDetector):
    ...
    def __init__(
        ...
        self.inf_compressor = MS_NaiveCompressor(
